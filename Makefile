...
SRC = src/main.c src/player_moves.c src/player_moves_tools.c src/intersections.c src/intersections_2.c src/tools_textures.c src/raycasting.c src/math.c src/tools.c \
